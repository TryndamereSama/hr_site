// MC1 HUB — Clientes MC1 (Placeholder)
  ...
  container.innerHTML = `
    <section class="section-sm" style="background: var(--color-surface-container-low);">
      <div class="container">
        ...
        <div class="page-header" style="padding-top:var(--space-6)">
          <span class="label-md" style="color:var(--color-primary)">${t('common.department')} — ${t('nav.operacional')}</span>
          <h1>${t('nav.operacional.clientes')}</h1>
          <p>${t('nav.operacional.clientes.sub')}</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        ...
        " data-reveal>
          <div class="icon-wrap icon-wrap-xl" style="background: linear-gradient(135deg, #0d9488, #14b8a6); color: white; margin-bottom: var(--space-6);">
            <svg width="36" height="36"><use href="#icon-users"/></svg>
          </div>
          ...
          <p class="body-lg text-muted" style="max-width: 38ch; margin-bottom: var(--space-8)">
            ${t('nav.operacional.clientes.coming_soon_desc')}
          </p>
          <div style="display:flex; gap: var(--space-3); flex-wrap: wrap; justify-content: center;">
            <a href="#/operacional" class="btn btn-outline">
