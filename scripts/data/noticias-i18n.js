...
<h3>Cómo Acceder</h3>
<p>Para registrar un reporte, envíe un correo electrónico a: <strong>relato.mc1@neivadelima.com.br</strong></p>
<h3>Confidencialidad</h3>
<p>Todos los reportes son tratados con total confidencialidad. El canal es gestionado de forma independiente, garantizando la seguridad y el anonimato de quien reporta.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Dudas? Contáctese con RH por el correo <strong>rh@mc1global.com</strong>.
    ...
    'speak-up-safely-2026': {
      title: 'Speak Up Safely MC1 — Nuevo Canal de Reportes Confidenciales',
...
<p>Mañana, <strong>20 de marzo de 2026</strong>, realizaremos la presentación oficial del canal. El evento será:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Fecha:</strong> 20/03/2026</li>
  <li><strong>Horario:</strong> 11h00 (BRT)</li>
  <li><strong>Formato:</strong> En línea</li>
</ul>
<h3>¿Qué es el Speak Up Safely?</h3>
<p>El Speak Up Safely es un canal seguro y confidencial creado para que todos los colaboradores puedan reportar preocupaciones, conductas inapropiadas o violaciones de políticas sin temor a represalias.</p>
<p>Espere más información sobre el acceso al canal después de la presentación oficial.</p>`,
    },

    'palestra-saude-mulher-2026': {
      title: 'Conferencia Salud de la Mujer — ¡Anote la Fecha! 💜',
...
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Fecha:</strong> 18 de marzo de 2026</li>
  <li><strong>Horario:</strong> 15h00 (BRT)</li>
  <li><strong>Formato:</strong> En línea</li>
</ul>
<h3>Sobre la Ponente</h3>
<p><strong>Tatyane de Andrade</strong> — Enfermera con <strong>12 años de experiencia</strong>, con posgrado en Urgencias y Emergencias, Ginecología y Obstetricia por el Instituto Einstein. Una profesional altamente calificada para abordar los temas más importantes relacionados con la salud femenina.</p>
<p>¡Guarde la fecha en su agenda y participe de esta iniciativa de bienestar promovida por MC1! 💜</p>`,
    },

    'convencao-sindpd-2026': {
      title: 'Convenio SINDPD 2026 — Todo lo que necesita saber',
...
<p>MC1, por liberalidad, ya había anticipado <strong>3% (tres por ciento)</strong> en la nómina de enero/2026. De esta forma, la diferencia de <strong>1% (un por ciento)</strong> será aplicada en la nómina de febrero/2026.</p>
<p>Destacamos que los colaboradores admitidos a lo largo de 2025 tendrán el reajuste aplicado de forma proporcional al tiempo de trabajo.</p>
<h3>Nuevo Salario Base 2026</h3>
<p>El nuevo piso salarial normativo pasa a ser <strong>R$ 2.500,00</strong>.</p>
<h3>Reajuste Auxilio Guardería</h3>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li>Niños hasta 24 meses: <strong>R$ 720,00</strong></li>
  <li>Niños hasta 6 años (5 años y 11 meses): <strong>R$ 630,00</strong></li>
</ul>
<h3>Auxilio para Hijos con Discapacidad</h3>
<p>Nuevo valor: <strong>R$ 900,00 (novecientos reales)</strong>.</p>
<h3>Licencia de Paternidad</h3>
<p>La licencia de paternidad pasa a ser de <strong>10 (diez) días hábiles</strong> en 2026. En 2027, pasa a ser de <strong>12 (doce) días hábiles</strong>.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Dudas? Contáctese con RH por el correo <strong>rh@mc1global.com</strong> o acceda a la página de <a href="#/contato" style="color: var(--color-primary); font-weight: 600;">Contacto</a>.
    ...
    'boas-vindas-gilberto-marquez': {
      title: '¡Bienvenido, Gilberto Márquez Ramírez! 👋',
...
<p>Gilberto trae consigo <strong>26 años de experiencia</strong> en el sector de tecnología y negocios, con pasos por empresas de gran relevancia en el mercado latinoamericano:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
...
<p>Su expertise abarca los segmentos de <strong>CPG, Consumo, Servicios y Consultoría</strong>, aportando una visión estratégica y amplia experiencia en desarrollo de negocios en la región.</p>
<p>¡Muy bienvenido, Gilberto! Estamos muy felices de tenerte en el equipo MC1. 🎉</p>`,
    },

    'novo-informe-rendimentos-2025': {
      title: 'ATENCIÓN — Nuevo Informe de Rendimientos 2025',
...
<h3>¿Qué cambió?</h3>
<p>Los <strong>valores totales no fueron modificados</strong>. El único cambio fue una redistribución en el <strong>campo 07</strong> del informe, conforme a la orientación del eSocial.</p>
<h3>¿Por qué es importante?</h3>
<p>Con el inicio del período de declaración del Impuesto a la Renta, es fundamental que utilice el <strong>nuevo informe</strong> para su declaración:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Inicio del plazo IR:</strong> 16 de marzo de 2026</li>
  <li><strong>Fin del plazo IR:</strong> 29 de mayo de 2026</li>
</ul>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Dudas? Contáctese con RH por el correo <strong>rh@mc1global.com</strong>.
    ...
    'adiantamento-salarial-2026': {
      title: 'Anticipo Reajuste Salarial — Anticipación del 3% en Enero',
...
<p>Cuando el índice definitivo del Convenio Colectivo sea conocido y homologado, la <strong>diferencia será ajustada de forma retroactiva</strong> al 01/01/2026, garantizando que todos los colaboradores reciban el valor correcto.</p>
...
<p>¡Que este día sirva de celebración, reflexión y renovación del compromiso con la igualdad, el respeto y las oportunidades para todas!</p>
<p>¡Feliz Día de la Mujer! 💜</p>`,
    },

    'aniversariantes-marco-2026': {
      title: '¡Feliz Cumpleaños a los Cumpleañeros de Marzo! 🎂',
...
<p>¡Que 2026 esté lleno de logros, salud y realizaciones para todos! 🎉</p>`,
    ...
    'programa-indicacao-2026': {
      title: 'Programa Referido Amigo MC1 — Refiere y Gana R$ 1.000',
...
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li>Identifique las vacantes abiertas en el portal interno</li>
  <li>Refiera a un candidato completando el formulario de referidos</li>
  <li>Siga el proceso de selección de su referido</li>
  <li>Reciba el bono después del período de prueba (90 días)</li>
</ul>
<h3>Valor del Bono</h3>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Dudas? Contáctese con RH por el correo <strong>rh@mc1global.com</strong>.
    ...
    'informe-rendimentos-2025': {
      title: 'Informe de Rendimientos 2025 — Disponible en Apdata',
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Problemas para acceder? Contáctese con RH por el correo <strong>rh@mc1global.com</strong>.
    ...
    'plr-2025': {
      title: 'PLR 2025 — Pago por Liberalidad de MC1',
...
<p>Aun así, MC1 Global, por <strong>liberalidad y compromiso con sus colaboradores</strong>, realizará el pago de <strong>R$ 500,00 (quinientos reales)</strong> a todos los colaboradores con contrato CLT activo.</p>
<h3>Fecha de Pago</h3>
<p>El pago se realizará el <strong>27 de febrero de 2026</strong>.</p>
<h3>Proporcionalidad</h3>
<p>Los colaboradores admitidos a lo largo de 2025 recibirán el valor de forma <strong>proporcional al período trabajado</strong> en el año.</p>
...
<p>El <strong>Miércoles de Ceniza, 18 de febrero de 2026</strong>, las actividades tendrán inicio a las <strong>12h00 (horario de Brasilia)</strong>.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  ¿Dudas? Contáctese con RH por el correo <strong>rh@mc1global.com</strong>.
    ...
    'aniversariantes-fevereiro-2026': {
      title: '¡Feliz Cumpleaños a los Cumpleañeros de Febrero! 🎂',
...
<p>¡Que 2026 esté lleno de logros, salud y realizaciones para todos! 🎉</p>`,
    ...
    'calendario-2026': {
      title: 'Calendario de Feriados 2026 — Brasil, México, EE.UU. y Grecia',
...
<h3>Principales feriados nacionales — Brasil</h3>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>01/01</strong> — Confraternización Universal (Feriado Nacional)</li>
  <li><strong>17/02</strong> — Carnaval (Feriado)</li>
  <li><strong>03/04</strong> — Viernes Santo (Feriado Nacional)</li>
  <li><strong>21/04</strong> — Tiradentes (Feriado Nacional)</li>
  <li><strong>01/05</strong> — Día del Trabajo (Feriado Nacional)</li>
  <li><strong>07/09</strong> — Independencia de Brasil (Feriado Nacional)</li>
  <li><strong>12/10</strong> — Nuestra Señora Aparecida (Feriado Nacional)</li>
  <li><strong>02/11</strong> — Día de los Muertos (Feriado Nacional)</li>
  <li><strong>15/11</strong> — Proclamación de la República (Feriado Nacional)</li>
  <li><strong>25/12</strong> — Navidad (Feriado Nacional)</li>
</ul>
<h3>Puentes y Autonomía de las Áreas</h3>
<p>No hay puentes oficiales determinados por la empresa. Cada área tiene autonomía para definir la compensación de horas, siempre que esté alineado con el gestor y registrado en el banco de horas.</p>
<h3>Receso de fin de año</h3>
<p>El receso de fin de año será del 26 de diciembre de 2026 al 2 de enero de 2027. Los colaboradores que necesiten trabajar en ese período deben alinearlo previamente con sus gestores.</p>
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Acceda al calendario completo en la página de <a href="#/politicas" style="color: var(--color-primary); font-weight: 600;">Documentos</a>.
</p>`,
    },

    'aniversariantes-janeiro-2026': {
      title: '¡Feliz Cumpleaños a los Cumpleañeros de Enero! 🎂',
...
<p>¡Que 2026 esté lleno de logros, salud y realizaciones para todos! 🎉</p>`,
    ...
    'convencao-sindpd-2026-inicial': {
      title: 'Convenio SINDPD 2026 — Comunicado Inicial y Período de Oposición',
...
<p>Los colaboradores que deseen <strong>oponerse al descuento de la contribución sindical</strong> deben hacerlo dentro del plazo establecido:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Inicio:</strong> 05 de enero de 2026</li>
  <li><strong>Término:</strong> 14 de enero de 2026</li>
  <li><strong>Horario:</strong> 09h a 17h</li>
</ul>
...
<h3>How to Access</h3>
<p>To submit a report, send an email to: <strong>relato.mc1@neivadelima.com.br</strong></p>
<h3>Confidentiality</h3>
<p>All reports are handled with complete confidentiality. The channel is managed independently, ensuring the safety and anonymity of those who report.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'speak-up-safely-2026': {
      title: 'MC1 Speak Up Safely — New Confidential Reporting Channel',
...
<p>Tomorrow, <strong>March 20, 2026</strong>, we will hold the official presentation of the channel. The event will be:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Date:</strong> 03/20/2026</li>
  <li><strong>Time:</strong> 11:00 AM (BRT)</li>
  <li><strong>Format:</strong> Online</li>
</ul>
<h3>What is Speak Up Safely?</h3>
<p>Speak Up Safely is a safe and confidential channel created so that all employees can report concerns, inappropriate conduct, or policy violations without fear of retaliation.</p>
<p>Stay tuned for more information about accessing the channel after the official presentation.</p>`,
    },

    'palestra-saude-mulher-2026': {
      title: "Women's Health Talk — Save the Date! 💜",
...
<h3>Event Details</h3>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Date:</strong> March 18, 2026</li>
  <li><strong>Time:</strong> 3:00 PM (BRT)</li>
  <li><strong>Format:</strong> Online</li>
</ul>
<h3>About the Speaker</h3>
<p><strong>Tatyane de Andrade</strong> — Nurse with <strong>12 years of experience</strong>, with a postgraduate degree in Emergency Care, Gynecology and Obstetrics from Instituto Einstein. A highly qualified professional to address the most important topics related to women's health.</p>
<p>Save the date in your calendar and join this wellness initiative promoted by MC1! 💜</p>`,
    },

    'convencao-sindpd-2026': {
      title: 'SINDPD 2026 Collective Agreement — Everything You Need to Know',
...
<p>MC1, at its discretion, had already advanced <strong>3% (three percent)</strong> in the January/2026 payroll. Therefore, the difference of <strong>1% (one percent)</strong> will be applied in the February/2026 payroll.</p>
<p>Please note that employees hired throughout 2025 will have the adjustment applied proportionally to their length of service.</p>
<h3>New 2026 Base Salary</h3>
<p>The new normative base salary becomes <strong>R$ 2,500.00</strong>.</p>
<h3>Childcare Allowance Adjustment</h3>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li>Children up to 24 months: <strong>R$ 720.00</strong></li>
  <li>Children up to 6 years (5 years and 11 months): <strong>R$ 630.00</strong></li>
</ul>
<h3>Allowance for Children with Disabilities</h3>
<p>New value: <strong>R$ 900.00 (nine hundred reais)</strong>.</p>
<h3>Paternity Leave</h3>
<p>Paternity leave becomes <strong>10 (ten) business days</strong> in 2026. In 2027, it increases to <strong>12 (twelve) business days</strong>.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong> or visit the <a href="#/contato" style="color: var(--color-primary); font-weight: 600;">Contact</a> page.
    ...
    'boas-vindas-gilberto-marquez': {
      title: 'Welcome, Gilberto Márquez Ramírez! 👋',
...
<p>Gilberto brings <strong>26 years of experience</strong> in the technology and business sector, having worked at highly relevant companies in the Latin American market:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Globant México</strong></li>
  <li><strong>IDS Comercial</strong></li>
  <li><strong>Teamcore Solutions</strong></li>
...
<p>His expertise spans the <strong>CPG, Consumer Goods, Services and Consulting</strong> segments, bringing a strategic vision and broad experience in business development across the region.</p>
<p>Welcome aboard, Gilberto! We are very happy to have you on the MC1 team. 🎉</p>`,
    },

    'novo-informe-rendimentos-2025': {
      title: 'ATTENTION — New 2025 Income Statement',
...
<h3>What changed?</h3>
<p>The <strong>total values have not been changed</strong>. The only change was a redistribution in <strong>field 07</strong> of the statement, as per eSocial's guidelines.</p>
<h3>Why is this important?</h3>
<p>With the start of the Income Tax filing period, it is essential that you use the <strong>new statement</strong> for your tax return:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Tax filing start date:</strong> March 16, 2026</li>
  <li><strong>Tax filing deadline:</strong> May 29, 2026</li>
</ul>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'adiantamento-salarial-2026': {
      title: 'Salary Adjustment Advance — 3% Advance in January',
...
<p>Once the definitive index of the Collective Bargaining Agreement is known and ratified, the <strong>difference will be adjusted retroactively</strong> to 01/01/2026, ensuring all employees receive the correct amount.</p>
...
<p>May this day serve as a celebration, reflection and renewal of our commitment to equality, respect and opportunities for all!</p>
<p>Happy Women's Day! 💜</p>`,
    },

    'aniversariantes-marco-2026': {
      title: 'Happy Birthday to the March Celebrants! 🎂',
...
<p>May 2026 be full of achievements, health and fulfillment for everyone! 🎉</p>`,
    ...
    'programa-indicacao-2026': {
      title: 'MC1 Referral Program — Refer and Earn R$ 1,000',
...
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li>Identify open positions on the internal portal</li>
  <li>Refer a candidate by filling out the referral form</li>
  <li>Track your referred candidate's selection process</li>
  <li>Receive your bonus after the probationary period (90 days)</li>
</ul>
<h3>Bonus Amount</h3>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'informe-rendimentos-2025': {
      title: '2025 Income Statement — Available on Apdata',
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Having trouble accessing? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'plr-2025': {
      title: 'PLR 2025 — Payment at MC1\'s Discretion',
...
<p>Even so, MC1 Global, out of <strong>goodwill and commitment to its employees</strong>, will make a payment of <strong>R$ 500.00 (five hundred reais)</strong> to all employees with an active CLT contract.</p>
<h3>Payment Date</h3>
<p>Payment will be made on <strong>February 27, 2026</strong>.</p>
<h3>Proportionality</h3>
<p>Employees hired throughout 2025 will receive the amount <strong>proportionally to the period worked</strong> during the year.</p>
<h3>Union Members</h3>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'feriado-carnaval-2026': {
      title: 'Carnival Holiday 2026 — Official Notice',
...
<h3>Ash Wednesday</h3>
<p>On <strong>Ash Wednesday, February 18, 2026</strong>, activities will begin at <strong>12:00 PM (Brasília time)</strong>.</p>
...
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Questions? Contact HR at <strong>rh@mc1global.com</strong>.
    ...
    'aniversariantes-fevereiro-2026': {
      title: 'Happy Birthday to the February Celebrants! 🎂',
...
<p>May 2026 be full of achievements, health and fulfillment for everyone! 🎉</p>`,
    ...
    'calendario-2026': {
      title: '2026 Holiday Calendar — Brazil, Mexico, USA and Greece',
...
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li>🇧🇷 <strong>Brazil (São Paulo)</strong></li>
  <li>🇲🇽 <strong>Mexico</strong></li>
  <li>🇺🇸 <strong>United States</strong></li>
  <li>🇬🇷 <strong>Greece</strong></li>
</ul>
<h3>Main national holidays — Brazil</h3>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>01/01</strong> — Universal Brotherhood Day (National Holiday)</li>
  <li><strong>02/17</strong> — Carnival (Holiday)</li>
  <li><strong>04/03</strong> — Good Friday (National Holiday)</li>
  <li><strong>04/21</strong> — Tiradentes (National Holiday)</li>
  <li><strong>05/01</strong> — Labor Day (National Holiday)</li>
  <li><strong>09/07</strong> — Brazilian Independence Day (National Holiday)</li>
  <li><strong>10/12</strong> — Our Lady of Aparecida (National Holiday)</li>
  <li><strong>11/02</strong> — All Souls' Day (National Holiday)</li>
  <li><strong>11/15</strong> — Proclamation of the Republic (National Holiday)</li>
  <li><strong>12/25</strong> — Christmas (National Holiday)</li>
</ul>
<h3>Bridge Days and Departmental Autonomy</h3>
<p>There are no official bridge days established by the company. Each department has the autonomy to define hour compensation, provided it is aligned with the manager and recorded in the hour bank.</p>
<h3>Year-end recess</h3>
<p>The year-end recess will run from December 26, 2026 to January 2, 2027. Employees who need to work during this period must align it in advance with their managers.</p>
<p style="margin-top: 1.5rem; padding: 1rem 1.25rem; background: var(--color-surface-container-low); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0;">
  Access the full calendar on the <a href="#/politicas" style="color: var(--color-primary); font-weight: 600;">Documents</a> page.
</p>`,
    },

    'aniversariantes-janeiro-2026': {
      title: 'Happy Birthday to the January Celebrants! 🎂',
...
<p>May 2026 be full of achievements, health and fulfillment for everyone! 🎉</p>`,
    ...
    'convencao-sindpd-2026-inicial': {
      title: 'SINDPD 2026 Collective Agreement — Initial Notice and Opposition Period',
...
<p>Employees who wish to <strong>oppose the union contribution deduction</strong> must do so within the established deadline:</p>
<ul style="padding-left: 1.5rem; margin: 1rem 0; display: flex; flex-direction: column; gap: 0.5rem;">
  <li><strong>Start:</strong> January 5, 2026</li>
  <li><strong>End:</strong> January 14, 2026</li>
  <li><strong>Hours:</strong> 9 AM to 5 PM</li>
</ul>
